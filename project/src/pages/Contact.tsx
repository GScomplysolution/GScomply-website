...
const companySizes = ['1–50 employees', '51–200 employees', '201–1,000 employees', '1,000+ employees'];
...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const submission = {
      ...
      company_size: (data.get('company_size') as string) || null,
              ...
              {status === 'success' ? (
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-gs-card space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      <label htmlFor="company_size" className="block text-sm font-medium text-gs-charcoal mb-1.5">
